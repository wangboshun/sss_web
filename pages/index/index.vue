	...
	<view>
		...
		<view class="cu-bar tabbar bg-white shadow foot">
			<view class="action" @click="NavChange" data-cur="mainpage">
				<view class="cuIcon-cu-image"><image :src="'/static/tabbar/mainpage' + [PageCur == 'mainpage' ? '_cur' : ''] + '.png'"></image></view>
				<view :class="PageCur == 'mainpage' ? 'text-green' : 'text-gray'">首页</view>
			</view>

			<view class="action" @click="NavChange" data-cur="manager">
				<view class="cuIcon-cu-image"><image :src="'/static/tabbar/manager' + [PageCur == 'manager' ? '_cur' : ''] + '.png'"></image></view>
