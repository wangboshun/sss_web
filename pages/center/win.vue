<template>
	<scroll-view class="page">
		...
		<view style="z-index: 1;"><canvas canvas-id="canvasArcbar1" class="charts" id="canvasArcbar1"></canvas></view>
		...
		<view class="response" style="z-index: 1;"><canvas canvas-id="canvasArcbar2" class="charts" id="canvasArcbar2"></canvas></view>
		...
		<view class="response" style="z-index: 1;"><canvas canvas-id="canvasArcbar3" class="charts" id="canvasArcbar3"></canvas></view>
	</scroll-view>
</template>
