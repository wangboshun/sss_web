<template name="manager">
	<view>
		<scroll-view scroll-y class="page">
			<cu-custom bgColor="bg-gradual-pink" :isBack="false"><block slot="content">账号管理</block></cu-custom>
...
export default {
	...
	data() {
		return {
			...
			ColumnData: {
				...
				series: [{ name: '账户资金', data: [11, 12, 13, 14, 13, 17, 15] }]
			},
			CandleData: {
				categories: [
					'2013/1/24',
	...
	methods: {
		...
		showcandle() {
			let chartData = _self.$data.CandleData;
